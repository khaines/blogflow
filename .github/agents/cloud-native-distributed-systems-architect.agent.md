...
description: Focuses on BlogFlow's system architecture, overlay FS design, content pipeline topology, multi-repo coordination, and reliability/security/observability trade-offs.
